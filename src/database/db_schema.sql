...
-- -----------------------------------------------------
-- Table `convention_vehicle`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `convention_vehicle` ;

SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `convention_vehicle` (
...
CREATE TABLE IF NOT EXISTS `customer_vehicle` (
  ...
  CONSTRAINT `fk_customer_vehicle_convention_vehicle1`
    ...
    REFERENCES `convention_vehicle` (`vehicle_id`)
    ON DELETE RESTRICT
    ON UPDATE RESTRICT)
ENGINE = InnoDB;

SHOW WARNINGS;
CREATE INDEX `fk_customer_vehicle_customer1_idx` ON `customer_vehicle` (`customer_id` ASC);

SHOW WARNINGS;
CREATE INDEX `fk_customer_vehicle_convention_vehicle1_idx` ON `customer_vehicle` (`convention_vehicle_id` ASC);

SHOW WARNINGS;
CREATE UNIQUE INDEX `unique_customer_vehicle_convention_vehicle_customer_id_idx` ON `customer_vehicle` (`customer_id` ASC, `convention_vehicle_id` ASC);

SHOW WARNINGS;
CREATE UNIQUE INDEX `vin_UNIQUE` ON `customer_vehicle` (`vin` ASC);
...
CREATE TABLE IF NOT EXISTS `job` (
  ...
  CONSTRAINT `fk_job_customer_vehicle1`
    ...
    REFERENCES `customer_vehicle` (`customer_vehicle_id`)
    ON DELETE RESTRICT
    ON UPDATE RESTRICT);
...
SHOW WARNINGS;
CREATE INDEX `fk_inventory_convention_vehicle1_idx` ON `inventory_item` (`convention_vehicle_id` ASC);

SHOW WARNINGS;
CREATE UNIQUE INDEX `unique_inventory_item_vechicle_item_code_idx` ON `inventory_item` (`item_code` ASC, `convention_vehicle_id` ASC);

SHOW WARNINGS;
CREATE INDEX `index_inventory_item_code_name_idx` ON `inventory_item` (`part_name` ASC, `item_code` ASC);
